...
class GamePositionRecorder():
    ...
    def step(self, actions: np.ndarray):
        for i, player in enumerate(self.game.players):
            disc = player.disc
            disc_value = [disc.position[0], disc.position[1], disc.velocity[0], disc.velocity[1],
                                     disc.collision_group, disc.collision_mask, disc.radius, disc.inverse_mass,
                                     disc.bouncing_coefficient, disc.damping]
