...
from haxballgym.utils.gamestates import PlayerData, PhysicsObject
...
class GameState(object):
    ...
    def update(self, state_floats: List[float]):
        """
    ...
    def _update(self, state_vals: List[float]):
