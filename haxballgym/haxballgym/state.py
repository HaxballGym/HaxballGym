...
class GameState:
    ...
    walls: np.ndarray = None  # (M, 4)  f64   ball-colliding walls [x0,y0,x1,y1] (raycast geometry)
    obstacles: np.ndarray = None  # (D, 3)  f64   static post discs [x,y,radius] (raycast obstacles)
