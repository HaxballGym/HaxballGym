...
class RewardFunction(ABC):
    @abstractmethod
    def get_rewards(self, state: GameState, prev: GameState,
                    terminated: np.ndarray, truncated: np.ndarray) -> np.ndarray: ...
...
class CombinedReward(RewardFunction):
    ...
    def get_rewards(self, state, prev, terminated, truncated):
        ...
        for fn, w in self.terms:
            r = w * fn.get_rewards(state, prev, terminated, truncated)
